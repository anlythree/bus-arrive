...
public enum UrlTypeEnum {
    ...
    // 公交路径规划2.0
    BUS_ROUTE_2("https://restapi.amap.com/v5/direction/transit/integrated",ServiceEnum.AMAP),
    // 步行路径规划
    ...
    // 行政区查询(查询城市编码)
    DISTRICT("https://restapi.amap.com/v3/config/district",ServiceEnum.AMAP),
